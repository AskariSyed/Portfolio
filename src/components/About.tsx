  ...
  return (
    <section
      ...
      style={{
        background:
          isDark
            ? 'linear-gradient(120deg, #0a0f1a 0%, #111827 50%, #0a0f1a 100%)'
            : 'linear-gradient(120deg, #f8fafc 0%, #a1c4fd 50%, #c2e9fb 100%)',
        boxShadow: isDark
          ? '0 8px 40px 0 rgba(0,0,0,0.55)'
          : '0 8px 40px 0 rgba(160,200,255,0.2)',
      }}
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <h2 className={`text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 ${isDark ? 'text-white' : 'text-slate-900'} drop-shadow-lg`}>About</h2>
        <div
